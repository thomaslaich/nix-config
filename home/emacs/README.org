...
- [[#keybindings][Keybindings]]
  ...
  - [[#buffer-keybindings-b][Buffer Keybindings (b)]]
  - [[#window-management-keybindings-w][Window-Management Keybindings (w)]]
  - [[#lisp-evaluation-keybindings-e][Lisp Evaluation Keybindings (e)]]
  - [[#dired-keybindings-d][Dired Keybindings (d)]]
  - [[#search-keybindings-f][Search Keybindings (f)]]
  - [[#git-keybindings-g][Git Keybindings (g)]]
  - [[#help-keybindings-h][Help Keybindings (h)]]
  - [[#insert-keybindings-i][Insert Keybindings (i)]]
  - [[#email-keybindings-e][Email Keybindings (e)]]
  - [[#org-mode-keybindings-o][Org-mode Keybindings (o)]]
  - [[#toggle-keybindings-t][Toggle Keybindings (t)]]
  - [[#code-keybindings-c][Code Keybindings (c)]]
  - [[#projectile-keybindings-p][Projectile Keybindings (p)]]
