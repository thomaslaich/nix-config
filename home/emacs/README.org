...
#+begin_src emacs-lisp
  (use-package kubernetes
    ...
    :init
    (defun my/kubernetes-evil-map ()
      "Set the keybindings for 'kubernetes-mode to be compatible with evil mode"
      (general-evil-define-key 'normal kubernetes-mode-map
        "?" 'kubernetes-config-popup
        "gr" 'kubernetes-refresh
        "gn" 'kubernetes-set-namespace
        "e" 'kubernetes-edit
        "l" 'kubernetes-logs
        "d" 'kubernetes-describe
        "c" 'kubernetes-display-config)))
  #+end_src
